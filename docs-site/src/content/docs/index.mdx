...
cd my-org && orgloop add module @orgloop/module-minimal
...
<CardGrid>
	...
	<Card title="Modules" icon="puzzle">
		Install entire workflows as packages. `orgloop add module @orgloop/module-engineering` gives you PR review, CI triage, ticket routing, and Claude Code supervision in one command.
	</Card>
</CardGrid>
